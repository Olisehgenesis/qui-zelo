...
const ButtonCool: React.FC<ButtonCoolProps> = ({
  ...
  // Calculate hover color if not provided (slightly darker)
  ...
  const displayBgColor = isDisabled ? '#6b7280' : (isHovered ? defaultHoverBg : bgColor);
  ...
  return (
    <button
      className={cn(
        ...
        !isDisabled && 'hover:-translate-x-[0.1em] hover:-translate-y-[0.1em]',
